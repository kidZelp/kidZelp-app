            ...
            <li className="flex text-dash-font flex-col gap-8 w-full">
              <Link
                ...
                className={`flex gap-1 ${
                  render === "dashboard" ? "text-white" : "text-gray-500"
                }`}
              >
                <Image src={dashboard} height="auto" width="13" alt="Dashboard Icon" />
                Dashboard
              </Link>
              <Link
                href=""
                onClick={() => handleItemClick("pointsgrabber")}
                className={`flex gap-1 ${
              ...
              >
                <Image src={icon} height="auto" width="13" alt="Icon" />
                Points Grabber
              </Link>
              <Link
                href=""
                onClick={() => handleItemClick("dailydairy")}
                className={`flex gap-1 ${
                  render === "dailydairy"
                    ? "text-white"
                    : "text-gray-500"
